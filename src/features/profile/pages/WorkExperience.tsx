// src/features/profile/pages/WorkExperience.tsx
...
const WorkExperience = forwardRef<StepFormRef, Props>(
  ({ onValidated }: Props, ref) => {
    ...
    return (
      <Box>
        ...
        <Grid container spacing={2}>
          ...
          {/* If not fresher, show job details */}
          {!isFresher && (
            <>
              ...
              <Grid size={{ xs: 12 }}>
                ...
                <Typography variant="caption" color="text.secondary" mt={0.5}>
                  Used to describe your current responsibilities. (Max 200
                  characters)
                </Typography>
              </Grid>
            </>
